    ...
    clients: [
        {
            ...
            post_logout_redirect_uris: [QLIKSENSE_LOGOUT_REDIRECT_URI.split(',').map(uri => uri.trim())],
        ...
        },
        {
            ...
            redirect_uris: [QLIKCLOUD_REDIRECT_URI.split(',').map(uri => uri.trim())],
            post_logout_redirect_uris: [QLIKCLOUD_LOGOUT_REDIRECT_URI.split(',').map(uri => uri.trim())],
        ...
        },
        {
            ...
            redirect_uris: [USERMANAGE_REDIRECT_URI.split(',').map(uri => uri.trim())],
            post_logout_redirect_uris: [USERMANAGE_LOGOUT_REDIRECT_URI.split(',').map(uri => uri.trim())],
        ...
        },
        {
            ...
            redirect_uris: [PUBLISHER_REDIRECT_URI.split(',').map(uri => uri.trim())],
            post_logout_redirect_uris: [PUBLISHER_LOGOUT_REDIRECT_URI.split(',').map(uri => uri.trim())],
